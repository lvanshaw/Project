...
# Example usage: generate 10 random records

# Tracker page for admin users
def load_data():
...
def save_upload(username, filename, filetype, description, priority, upload_type, processed=False, result=None, speed_clicked=False, detection_clicked=False):
